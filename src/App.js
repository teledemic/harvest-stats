...
class App extends Component {
			...
			<div className="App">
				...
				}
				{
					...
					<div>
						...
						<YearHeatmap days={this.state.dayGraph.days} year={2018}></YearHeatmap>
					</div>
				}
			</div>
		);
	...
	heatmapClassForValue(value) {
		...
		if (value.hours < 2) return `color-github-1`;
		if (value.hours < 4) return `color-github-2`;
		if (value.hours < 6) return `color-github-3`;
